...
function EmployeeDashboard({ user, setUser }) {
  ...
  const calculateCurrentSalary = () => {
    ...
    const currentSalary =
      dailySalary * currentDay - advanceAmount - leaveDeduction;
                ...
                return (
                  <div style={{ textAlign: "center", padding: "20px" }}>
                    <div style={{ fontSize: "18px", opacity: 0.9 }}>
                      Chưa có thông tin lương cho tháng này. Vui lòng liên hệ
                      quản lý để được đặt lương.
                    </div>
                  </div>
                );
              }
              ...
              return (
                ...
                >
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: "24px", fontWeight: "bold" }}>
                      {new Intl.NumberFormat("vi-VN").format(
                        Math.round(salaryCalc.dailySalary)
                      )}{" "}
                      VNĐ
                    </div>
                  </div>
                  <div>
                    ...
                    >
                      Số ngày trong tháng (tính từ đầu tháng)
                    </div>
                    <div style={{ fontSize: "24px", fontWeight: "bold" }}>
                  ...
                  <div>
                    ...
                    >
                      -
                      {new Intl.NumberFormat("vi-VN").format(
                        Math.round(salaryCalc.leaveDeduction)
                      )}{" "}
                      VNĐ
                    </div>
                  </div>
                  ...
                  >
                    ...
                    >
                      Lương hiện tại (tính đến ngày {salaryCalc.currentDay}/
                      {new Date().getMonth() + 1})
                    </div>
                    <div
                      style={{
                        ...
                        fontWeight: "bold",
                        color:
                          salaryCalc.currentSalary >= 0 ? "#ffd700" : "#ff6b6b",
                      }}
                    >
                      {new Intl.NumberFormat("vi-VN").format(
                        Math.round(salaryCalc.currentSalary)
                      )}{" "}
                      VNĐ
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        fontWeight: "bold",
                        color:
                          salaryCalc.maxAdvanceAmount >= 0
                            ? "#4ade80"
                            : "#ff6b6b",
                      }}
                    >
                      {new Intl.NumberFormat("vi-VN").format(
                        Math.round(salaryCalc.maxAdvanceAmount)
                      )}{" "}
                      VNĐ
                    </div>
                    <div
                    ...
                    >
                      ...
                      VNĐ - 4 ngày lương:{" "}
                      {new Intl.NumberFormat("vi-VN").format(
                        Math.round(salaryCalc.fourDaysSalary)
                      )}{" "}
                      VNĐ)
                    </div>
                  </div>
                  ...
                  <div className="request-header">
                    <div>
                      ...
                      <p className="request-date">
                        ...
                        {request.endTimePeriod &&
                          request.startTimePeriod !== request.endTimePeriod &&
                          !request.timePeriod &&
                          ` (${request.endTimePeriod})`}
                      </p>
                    </div>
